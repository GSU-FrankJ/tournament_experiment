...
- Read STATE.md (if it exists) before starting any task
```
...
After completing a task, update `STATE.md` at repo root with: what was done, current known issues, suggested next steps. Create it if it doesn't exist.
