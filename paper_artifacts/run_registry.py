...
from .config import CONVERGENCE_DIR, CSV_PATH, Q_VALUES
...
def discover_runs(
    ...
    if not os.path.exists(convergence_dir):
        warnings.warn(f"Convergence directory not found: {convergence_dir}")
        return runs
    ...
    json_files = sorted([
        f for f in os.listdir(convergence_dir)
    ...
    for filename in json_files:
        ...
        metadata_path = os.path.join(convergence_dir, metadata_filename)
