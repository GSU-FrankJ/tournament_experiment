...
Usage:
    ...
    python -m paper_artifacts --dry-run
    
    # Generate all artifacts
    python -m paper_artifacts make_all
    
    # Generate specific figure
    python -m paper_artifacts plot convergence_main
    
    # Generate specific table
    python -m paper_artifacts table summary_metrics
...
def main():
    ...
    parser.add_argument(
        "--runs-dir",
        default=CONVERGENCE_DIR,
        help=f"Path to convergence_history directory (default: {CONVERGENCE_DIR})",
    )
    parser.add_argument(
        "--csv",
        default=CSV_PATH,
